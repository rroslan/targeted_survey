defmodule TargetedSurveyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TargetedSurveyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TargetedSurveyWeb.Gettext, "errors", msg, opts)
    end
  end
