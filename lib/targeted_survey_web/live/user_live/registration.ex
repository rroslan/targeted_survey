defmodule TargetedSurveyWeb.UserLive.Registration do
  use TargetedSurveyWeb, :live_view

  alias TargetedSurvey.Accounts
  alias TargetedSurvey.Accounts.User
  ...
  def mount(_params, _session, %{assigns: %{current_scope: %{user: user}}} = socket)
    ...
    {:ok, redirect(socket, to: TargetedSurveyWeb.UserAuth.signed_in_path(socket))}
  end
