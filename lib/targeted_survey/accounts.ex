defmodule TargetedSurvey.Accounts do
  @moduledoc """
  The Accounts context.
  """

  import Ecto.Query, warn: false
  alias TargetedSurvey.Repo

  alias TargetedSurvey.Accounts.{User, UserToken, UserNotifier}
  ...
  See `TargetedSurvey.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `TargetedSurvey.Accounts.User.password_changeset/3` for a list of supported options.
